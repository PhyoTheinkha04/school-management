                            ...
                            <div class="mb-3 input-group search-area mb-md-0">
                                <form action="{{ url('admin/course/search') }}" method="post">
                                    ...
                                    <div class="mb-3 input-group">
                                        <input type="text" name="course_name" id="course" class="p-3 form-control" value="{{ $search_data['course_name'] ?? '' }}">
                            ...
                            <table class="table-responsive-lg table display dataTablesCard student-tab dataTable no-footer" id="example-student">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="trans-list">
                                                <span class="text-primary font-w600"> {{ Str::limit($courses->contents, 30, '...') }}</span>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <form action="{{ route('admin.course.destroy', $courses->id) }}" method="POST">
                                                ...
                                                <a class="btn btn-outline-primary btn-xxs mr-2" href="{{ route('admin.course.edit', $courses->id) }}">Edit</a>
