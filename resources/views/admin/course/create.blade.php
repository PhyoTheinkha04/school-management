                                            ...
                                            <div class="col-xl-8 col-sm-8 col-md-8">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="title" id="title"
                                                        value="{{ old('title') }}" class="form-control col-6">
                                                    @error('title')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                                <div class="mb-3">
                                                    <label for="level_id" class="form-label text-primary">Levels<span
                                                            class="required">*</span></label>
                                                    <select name="level_id" id="level_id" class="form-control">
                                                        <option value="">Select Level</option>
                                                        @foreach ($levels as $newlevels)
                                                            <option value="{{ $newlevels->id }}">{{ $newlevels->name }}
                                                            </option>
                                                        @endforeach
                                                ...
                                                <div class="">
                                                    <div class="mb-3">
                                                        <label for="contents" class="form-label text-primary">content<span
                                                                class="required">*</span></label>
                                                        <textarea name="contents" id="contents" class="form-control" rows="6">{{ old('content') }}</textarea>
                                                        @error('contents')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
