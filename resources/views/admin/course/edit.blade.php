                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-8 col-sm-8 col-md-8">
                                            ...
                                            <div class="col-xl-6 col-sm-6">
                                                <div class="mb-3">
                                                    <label for="level_id"
                                                        class="form-label text-primary">Levels<span
                                                            class="required">*</span></label>
                                                    <select name="level_id" id="level_id"
                                                        class="form-control col-6">

                                                        @foreach ($levels as $newlevels )
                                                        <option value="{{$newlevels->id}}" @if($newlevels->id ==
                                                            $course->levels_id ) selected
                                                            @endif>{{ $newlevels->name  }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea name="contents" id="contents" class="form-control"
                                                    rows="6">{{ $course->contents }}</textarea>
                                                @error('contents')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="form-check">
                                                    <input value="1" class="form-check-input" type="radio" name="status"
                                                        id="status1" {{ $course->status == 1 ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check ms-3">
                                                    <input class="form-check-input" type="radio" value="0" name="status"
                                                        id="status" {{ $course->status == 0 ? 'checked' : '' }}>
                                            ...
                                            <div class="mt-3">
                                                <button class="btn btn-outline-primary me-3"><a
                                                        href="{{ url('admin/course') }}">Back</a></button>
