                                ...
                                <form action="{{ route('admin.new.store') }}" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-8 col-sm-8 col-md-8">
                                            <div class="mb-3">
                                                <label for="titile" class="form-label text-primary">Title<span class="required">*</span></label>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="tags_id" id="tags_id" class="form-control">
                                                    ...
                                                    <option value="{{ $newtags->id }}" @if ($newtags->id == old('tags_id'))
                                                     selected @endif>
                                                     {{ $newtags->name }}
                                                    </option>
                                                    @endforeach
                                            ...
                                            <div class="">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="contents" id="contents" class="form-control"
                                                        rows="6" value="">{{ old('contents') }}</textarea>
                                                    @error('contents')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
